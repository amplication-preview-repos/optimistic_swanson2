...
@InputType()
class BlogPostCreateNestedManyWithoutCategoriesInput {
...
export { BlogPostCreateNestedManyWithoutCategoriesInput as BlogPostCreateNestedManyWithoutCategoriesInput };
